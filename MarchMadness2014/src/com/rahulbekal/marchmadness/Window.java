...
public class Window extends JFrame{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6361351841395266109L;
	...
	private static void addTitleAndTeams()
	{
		...
		title = new JLabel("MARCH MADNESS Simulator by Rahul Bekal");
	...
	private static void initLabels()
	{
		...
		statLabels[0][2] = new JLabel("Wildcard/ Upset Factor: ");
		...
		statLabels[1][2] = new JLabel("Wildcard/ Upset Factor: ");
		statLabels[1][3] = new JLabel("Average Points Per Game: ");
		//statLabels[1][4] = new JLabel("FG% Per Game: ");
		statLabels[1][4] = new JLabel("Average Points Allowed Per Game: ");
